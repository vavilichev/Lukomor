...
namespace Lukomor.TagsGame.TagsGrid
{
	...
	{
		private readonly SignalTower _signalTower;
		private readonly IGridRepository _repository;
		private IGrid _cachedGrid;

		public GridFeature(DiContainer container, IGridRepository repository) : base(container)
		{
			_repository = repository;
			_signalTower = container.Get<SignalTower>();
		}
