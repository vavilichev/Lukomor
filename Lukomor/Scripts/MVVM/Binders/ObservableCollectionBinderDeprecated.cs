...
{
    public abstract class ObservableCollectionBinderDeprecated : BinderDEPRECATED
    {
        public abstract Type ArgumentType { get; }
    }

    public abstract class ObservableCollectionBinderDeprecated<T> : ObservableCollectionBinderDeprecated where T : IViewModel
    {
